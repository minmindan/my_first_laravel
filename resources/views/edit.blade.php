    ...
    <div class="box" style="height: unset" >
        <div class="int" style="height: unset">
            ...
            <div class="mess1" style="margin-bottom: 20px; padding-bottom:20px; border-bottom:solid 1px;" >
                ...
                justify-content: space-between; ">
                    ...
                    <div class="time1" style="margin-top:-5px;width:30%">
                        <span>時間:</span>
                        <span style="color: red">{{$item->created_at}}</span>
                    </div>
                </div>
            ...
            <div class="up" style="margin-top: 50px">
                <form action="/img/update/{{$alpha->id}}" method="GET">
                    <div class="mb-3">
                        <label for="exampleFormControlInput1">作者</label>
                        <input type="text" class="form-control" value="{{$alpha->text}}" style="width:50%" name="name" id="exampleFormControlInput1">
                      </div>
                      <div class="mb-3 message">
                        <label for="exampleFormControlInput1">標題</label>
                        <input type="text" class="form-control" value="{{$alpha->author}}" style="width:50%" name="title" id="exampleFormControlInput1">
                      </div>
                      <div class="mb-3 message">
                        <label for="exampleFormControlInput1">內容</label>
                        <input type="text" class="form-control" value="{{$alpha->email}}" style="width:50%" name="content" id="exampleFormControlInput1">
                      </div>
