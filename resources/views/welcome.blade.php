                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="/microsoft"
                                    class="underline text-gray-900 dark:text-white">微軟仿切</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://minmindan.github.io/bootstarp/"
                                    class="underline text-gray-900 dark:text-white">bootstarp</a></div>
                        </div>
